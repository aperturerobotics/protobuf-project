...
#include "other_srpc.pb.hpp"

namespace other {

starpc::Error SRPCEchoerClientImpl::Echo(const other::EchoMsg& in, other::EchoMsg* out) {
  return cc_->ExecCall(service_id_, "Echo", in, out);
}

std::pair<std::unique_ptr<SRPCEchoer_EchoServerStreamClient>, starpc::Error> SRPCEchoerClientImpl::EchoServerStream(const other::EchoMsg& in) {
