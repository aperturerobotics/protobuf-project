...
constexpr const char* kSRPCEchoerServiceID = "other.Echoer";
...
class SRPCEchoerClient {
 public:
  ...
  // Echo
  virtual starpc::Error Echo(const other::EchoMsg& in, other::EchoMsg* out) = 0;
  // EchoServerStream
  virtual std::pair<std::unique_ptr<SRPCEchoer_EchoServerStreamClient>, starpc::Error> EchoServerStream(const other::EchoMsg& in) = 0;
  // EchoClientStream
...
class SRPCEchoerClientImpl : public SRPCEchoerClient {
 public:
  ...
  // Echo
  virtual starpc::Error Echo(const other::EchoMsg& in, other::EchoMsg* out) override;
  // EchoServerStream
  virtual std::pair<std::unique_ptr<SRPCEchoer_EchoServerStreamClient>, starpc::Error> EchoServerStream(const other::EchoMsg& in) override;
  // EchoClientStream
...
class SRPCEchoerServer {
 public:
  ...
  // Echo
  virtual starpc::Error Echo(const other::EchoMsg& req, other::EchoMsg* resp) = 0;
  // EchoServerStream
  virtual starpc::Error EchoServerStream(const other::EchoMsg& req, SRPCEchoer_EchoServerStreamStream* strm) = 0;
  // EchoClientStream
  virtual starpc::Error EchoClientStream(SRPCEchoer_EchoClientStreamStream* strm, other::EchoMsg* resp) = 0;
  // EchoBidiStream
...
class SRPCEchoer_EchoServerStreamClient {
 public:
  ...
  starpc::Error Recv(other::EchoMsg* msg) {
...
class SRPCEchoer_EchoServerStreamStream {
 public:
  ...
  starpc::Error Send(const other::EchoMsg& msg) {
    return strm_->MsgSend(msg);
  }

  starpc::Error SendAndClose(const other::EchoMsg& msg) {
...
class SRPCEchoer_EchoClientStreamClient {
 public:
  ...
  starpc::Error CloseAndRecv(other::EchoMsg* msg) {
