...
func (c *echoerClient) EchoServerStream(ctx context.Context, in *EchoMsg, opts ...grpc.CallOption) (Echoer_EchoServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echoer_ServiceDesc.Streams[0], "/echo.Echoer/EchoServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoerClient) EchoClientStream(ctx context.Context, opts ...grpc.CallOption) (Echoer_EchoClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echoer_ServiceDesc.Streams[1], "/echo.Echoer/EchoClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoerClient) EchoBidiStream(ctx context.Context, opts ...grpc.CallOption) (Echoer_EchoBidiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Echoer_ServiceDesc.Streams[2], "/echo.Echoer/EchoBidiStream", opts...)
	if err != nil {
		return nil, err
	}
...
var Echoer_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aperturerobotics/protobuf-project/example/echo.proto",
}
