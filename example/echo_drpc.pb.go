...
type drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto struct{}

func (drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return drpc1.Marshal(msg)
}

func (drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto) Unmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcEchoerClient) Echo(ctx context.Context, in *EchoMsg) (*EchoMsg, error) {
	out := new(EchoMsg)
	err := c.cc.Invoke(ctx, "/echo.Echoer/Echo", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcEchoerClient) EchoServerStream(ctx context.Context, in *EchoMsg) (DRPCEchoer_EchoServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, "/echo.Echoer/EchoServerStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcEchoer_EchoServerStreamClient{stream}
	if err := x.MsgSend(in, drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{}); err != nil {
		return nil, err
	}
...
func (x *drpcEchoer_EchoServerStreamClient) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcEchoer_EchoServerStreamClient) Recv() (*EchoMsg, error) {
	m := new(EchoMsg)
	if err := x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcEchoer_EchoServerStreamClient) RecvMsg(m *EchoMsg) error {
	return x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{})
}

func (c *drpcEchoerClient) EchoClientStream(ctx context.Context) (DRPCEchoer_EchoClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, "/echo.Echoer/EchoClientStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcEchoer_EchoClientStreamClient) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcEchoer_EchoClientStreamClient) Send(m *EchoMsg) error {
	return x.MsgSend(m, drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{})
}
...
func (c *drpcEchoerClient) EchoBidiStream(ctx context.Context) (DRPCEchoer_EchoBidiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, "/echo.Echoer/EchoBidiStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcEchoer_EchoBidiStreamClient) GetStream() drpc.Stream {
	return x.Stream
}
...
func (DRPCEchoerDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/echo.Echoer/Echo", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{},
	...
	case 1:
		return "/echo.Echoer/EchoServerStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 2:
		return "/echo.Echoer/EchoClientStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCEchoerServer).
					EchoClientStream(
	...
	case 3:
		return "/echo.Echoer/EchoBidiStream", drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCEchoerServer).
					EchoBidiStream(
...
func (x *drpcEchoer_EchoStream) SendAndClose(m *EchoMsg) error {
	if err := x.MsgSend(m, drpcEncoding_File_github_com_aperturerobotics_protobuf_project_example_echo_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
